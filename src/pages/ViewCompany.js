            ...
            <tbody>
              {data && data.map((row, rowIndex) => (
                <tr key={rowIndex} className="border-collapse text-center">
                  ...
                  <td className="py-2 px-4 border">
                    <img src={`http://localhost:8080${row.companylogo}`} alt={row.companylogo} />
                    {/* <img src={`https://images.pexels.com/photos/9143680/pexels-photo-9143680.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load`} /> */}
                  </td>
                  {/* ))} */}
                </tr>
              ))}
