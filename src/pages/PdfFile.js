...
const PdfFile = ({ data }) => {
  ...
  useEffect(() => {
    ...
    generatePdf(); // Generate PDF when the component mounts
  }, [data]);
  return (
    // <div className='modal-content'>
    //   <span className="close" onClick={onClose}>&times;</span>
    <div class="pdf" ref={pdfRef}>
      ...
      <div class="mainParaPdf">
        ...
        <p>
          Enjoy the many shades of Dubai. From the stunning skylines to the mystical deserts and bustling markets to luxurious malls. Hop on cruises or get your thrill with watersports, there's something for everyone!
        </p>
      </div>
      <div class="contentQuotation">
        ...
        <div class="quotation">
          <p>
            Curated by
            <br />
            <span class="curated-by">Smita Gupta</span>
          </p>
          <p class="contact-info">
            Call: 9311300245
            <br />
            Email: smita.gupta@makemytrip.in
          </p>
          <p>
            Quotation Created on 11 Jul 2024
            <br />
            01:52 PM
          </p>
        </div>
      ...
      <div class="transfer-section2">
        ...
        <div class="transfer-details2">
          ...
          <div>
            <p>
              <strong>
                Burj Khalifa At the Top + Aquarium & Underwater Zoo
              </strong>
            </p>
            <p>
              Burj Khalifa At the Top Non-Prime Time with Aquarium &
              Underwater zoo combo Tickets Only with Shared Transfers
              ZONE-1 : Bur Dubai /Deira /SZR /Downtown / business bay
            </p>
            <p>
              &#x23F0;  Duration 4 Hours
            </p>
      ...
      <div class="payOnlinePdf">
        ...
        <div>
          ...
          Smita Gupta
          <br />
          <a href="tel:9311300245">9311300245</a>
        </div>
      </div>
      <div class="pay-now">
        <a href="#">Pay Now</a>
      ...
      <div class="payment-schedule">
        <div class="paymentOption">
          ...
          <h3 class="highlight">₹ 1,48,696</h3>
        </div>
      ...
      <div class="getIntochSecPDF">
        <div class="getIntochSecPDFLeft">
          <h5>
            Curated by
            <br />
            <span>Smita Gupta</span>
          </h5>
        </div>
        <div class="getIntochSecPDFRight">
          <p>
            Call:
            <span>9311300245</span>
          </p>
          <p>
            Email:
            <span>smita.gupta@makemytrip.in</span>
          </p>
        </div>
      </div>
      <div class="getIntochSecPDF">
